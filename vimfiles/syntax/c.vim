...
if !exists("c_no_c99") " ISO C99
  ...
  syn keyword	cType		AISTD string SOBSession CSocketPool CBSErrorMsg
  syn keyword	cType		CStringHashMap CStringMap CStringListList CBoolList CBoolMap
  syn keyword	cType		otl_connect otl_exception otl_stream
...
if !exists("c_no_ansi") || exists("c_ansi_constants") || exists("c_gnu")
  ...
  " custome
  syn keyword cConstant OBD_OK OBD_FAIL OBD_EXCEPTION DMCEXT_ERROR_LOG DMCEXT_EXCEPTION_LOG 
  syn keyword cConstant DMCEXT_NO_DATA_ERROR DMCEXT_LOG_BEG DMCEXT_LOG_END DMCEXT_INIT DMCEXT_COMMIT_ERROR DMCEXT_COMMIT_OK
endif
if !exists("c_no_c99") " ISO C99
